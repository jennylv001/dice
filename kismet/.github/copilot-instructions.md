...
Project Context:
[Enable realtime fair competitive dice rolling between distant remote players, preventing video/sensor spoofing using multi-modal stimuli and cryptographic proofs.]

Development Operations:
- Commit frequently with compact and descriptive messages
- Document breaking changes
- Production functionality ONLY - no demos/experiments

Deployment operations:
- macbookpro@MacBooks-MacBook-Pro kismet % npm run deploy:worker

- macbookpro@MacBooks-MacBook-Pro kismet % npm run build:app

- macbookpro@MacBooks-MacBook-Pro kismet % npx wrangler pages deploy app/dis